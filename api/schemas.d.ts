...
export interface ApiArticleArticle extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    author: EnumerationAttribute<['galliano.salvadorj', 'devrzzt.tech']> &
      RequiredAttribute &
      SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    time_read: EnumerationAttribute<['min 3', 'min 5', 'min 10']> &
      RequiredAttribute &
      SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiDiscountDiscount extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    buttonBackground: EnumerationAttribute<
    ...
    buttonColor: EnumerationAttribute<['light', 'dark']> &
      RequiredAttribute &
      SetPluginOptions<{
        i18n: {
          localized: false;
